...
canvas#heroGlobe{position:absolute;right:16%;top:50%;transform:translateY(-50%);width:680px;height:680px;z-index:0;pointer-events:none;opacity:0.92;}
        ...
        <div className="section-inner">
          ...
          <div className="prod-grid reveal">
            ...
            <div className="prod-card featured">
              ...
              <img src={auromLogo} alt="AUROM & AUROM PRO" style={{ width: "62%", maxWidth: "62%", marginTop: "1.4rem", display: "block" }} />
            </div>
          </div>
